...
{
    public class DocumentTypes1Controller : Controller
    {
        ...
        // GET: DocumentTypes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: DocumentTypes1/Create
