...
namespace Icosoft.Controllers
{
    public class QuotationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idQuotation,DateCompleted,Quantity,State,TypeQuotation,incidentals,Transport,TotalLabor,CustomerValue,TotalProduction")] Quotation quotation)
        {
            if (ModelState.IsValid)
            {
