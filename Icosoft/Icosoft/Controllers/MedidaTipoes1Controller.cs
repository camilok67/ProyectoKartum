...
{
    public class MedidaTipoes1Controller : Controller
    {
        ...
        // GET: MedidaTipoes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: MedidaTipoes1/Create
